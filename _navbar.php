<nav class="bg-white border-gray-600 border-b-2 rounded-b-xl">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <span class="self-center text-2xl font-bold whitespace-nowrap">Wewin Event</span>
        </a>
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-multi-level">
            <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white">
                ...
                <li>
                    <a href="orders.php" class="block py-2 px-3 text-blue-700 font-bold rounded md:bg-transparent md:text-blue-700 md:p-0" aria-current="page">Booking</a>
                </li>
                <li>
